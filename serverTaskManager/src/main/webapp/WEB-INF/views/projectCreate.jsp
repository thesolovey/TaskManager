...
<html>
    ...
    <body class="w3-light-grey">
            ...
            <div class="w3-card-4">
               <div class="w3-container w3-center w3-light-blue">
                  ...
                  <form method="post" class="w3-selection w3-light-grey w3-padding">
                      <label>Project Name:
                          <input type="text" name="projectName" class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br />
                      </label>
     ...
     <div class="w3-container w3-light-grey w3-opacity w3-left-align w3-padding">
            <button class="w3-btn w3-round-large" onclick="location.href='/userMainPage'"><i class="fa fa-search"></i> Go to User Main Page</button>
     </div>
