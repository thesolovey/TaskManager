...
public class EndpointDataBaseService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint/", "EndpointDataBaseService");
    public final static QName EndpointDataBasePort = new QName("http://endpoint/", "EndpointDataBasePort");
    static {
        URL url = null;
        try {
