...
public interface EndpointProject {
    ...
    @WebMethod
    @Action(input = "http://endpoint/EndpointProject/findAllProjectRequest", output = "http://endpoint/EndpointProject/findAllProjectResponse", fault = {@FaultAction(className = AccessForbiddenException_Exception.class, value = "http://endpoint/EndpointProject/findAllProject/Fault/AccessForbiddenException")})
