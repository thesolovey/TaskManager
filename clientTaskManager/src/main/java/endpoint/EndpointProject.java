...
public interface EndpointProject {
    ...
    @WebMethod
    @Action(input = "http://endpoint/EndpointProject/clearAllProjectListRequest", output = "http://endpoint/EndpointProject/clearAllProjectListResponse", fault = {@FaultAction(className = AccessForbiddenException_Exception.class, value = "http://endpoint/EndpointProject/clearAllProjectList/Fault/AccessForbiddenException")})
