...
public class EndpointSessionService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.sdima.gmail.com/", "EndpointSessionService");
    public final static QName EndpointSessionPort = new QName("http://endpoint.sdima.gmail.com/", "EndpointSessionPort");
    static {
        URL url = null;
        try {
